		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
				<div class="navbar-nav">
					...
					<a class="nav-link active" href="main?action=addPublisherLink"><fmt:message key="nav.addPublisher"/></a>
		...
		<form action="main?action=updatePublisher" method="post">
			...
			<table>
				<tr>
					...
					<td><input class="form-control" type="text" name="name" value="${publisher.name}"></td>
					<td><label style="color: red">${errors.name}</label></td>
				</tr>
			</table>
			<br> <br> <input class="btn btn-outline-secondary"
				type="submit" value="<fmt:message key="button"/>">
		</form>
	</div>
</body>
</html>