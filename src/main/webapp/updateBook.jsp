		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
				<div class="navbar-nav">
					...
					<a class="nav-link active" href="main?action=getAllBooks"><fmt:message	key="nav.updateBook"/></a>
	...
	<div style="margin: 20px;">
		...
		<form action="main?action=updateBook" method="post">
			<input type="hidden" name="bId" value="${book.id}"> <input
				type="hidden" name="oldQuantity" value="${book.quantity}">
			<table>
				<tr>
				...
				<tr>
					...
					<td><input class="form-control" type="text" name="available"
						value="${book.available}" readonly></td>
				</tr>
				<tr>
