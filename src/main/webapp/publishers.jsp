		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
				<div class="navbar-nav">
					...
					<a class="nav-link active" href="main?action=getAllPublishers"><fmt:message key="nav.updatePublisher"/></a>
			...
			<c:forEach var="publisher" items="${publishers}">
				<tr>
					...
					<td><a class="btn btn-outline-secondary"
						href="main?action=preparePublisher&pId=${publisher.id}"><fmt:message
								key="button" /></a></td>
				</tr>
			</c:forEach>
		</table>
